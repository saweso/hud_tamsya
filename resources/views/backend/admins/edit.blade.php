...
<!-- Content area -->
    <div class="content">
        ...
        <!-- 2 columns form -->
        <form class="form-horizontal" action="/admins/{{$admin->id}}" method="POST" enctype="multipart/form-data">
           {{ csrf_field() }}
           {{method_field('PUT')}}
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            <fieldset>
                                <legend class="text-semibold"><i class="icon-office position-left"></i> {{$admin->name}} DETAILS</legend>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text"  name="mobile"  class="form-control" placeholder="Mobile" value="{{ $admin->mobile }}">
                                    </div>
                                </div>
                                <div class="form-group">
