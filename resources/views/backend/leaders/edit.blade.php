                        ...
                        <div class="col-md-12">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="first_name"  class="form-control" placeholder="Ingiza Jina la kwanza" value="{{ $leader->first_name }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">JINA LA KATI:</label>
                                    <div class="col-md-6">
                                        <input type="text" name="middle_name"  class="form-control" placeholder="Ingiza Jina la Kati" value="{{ $leader->middle_name }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">JINA LA MWISHO:</label>
                                    <div class="col-md-6">
                                        <input type="text" name="last_name"  class="form-control" placeholder="Ingiza Jina la Mwisho" value="{{ $leader->last_name }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">CHEO:</label>
                                    <div class="col-md-6">
                                        <input type="text"  name="cheo"  class="form-control" placeholder="Ingiza cheo cha kiongozi" value="{{ $leader->cheo }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">NAMBA YA SIMU:</label>
                                    <div class="col-md-6">
                                        <input type="text"  name="mobile"  class="form-control" placeholder="Ingiza namba ya simu" value="{{ $leader->mobile }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">BARUA PEPE:</label>
                                    <div class="col-md-6">
                                        <input type="text"  name="email"  class="form-control" placeholder="Ingiza barua pepe" value="{{ $leader->email }}">
                                    </div>
                                </div>
                                <div class="form-group">
